      ...
      body: Stack(
        children: [
          ...
          Column(
            children: [
              Container(
                color: isAboutUsSelected
                    ? Colors.black
                    : Colors.brown[900]?.withOpacity(0.7),
                padding:
                          ...
                          Row(
                            children: [
                              NavButton(
                                  text: 'Home',
                                  onTap: () =>
                                      scrollToSection(homeKey, context, false)),
                              NavButton(
                                  text: 'About Us',
                                  onTap: () =>
                                      scrollToSection(aboutKey, context, true)),
                              NavButton(
                                  text: 'Discover',
                                  onTap: () => scrollToSection(
                                      discoverKey, context, false)),
                              NavButton(
                                  text: 'Career',
                                  onTap: () => scrollToSection(
                                      careerKey, context, false)),
                              NavButton(
                                  text: 'Contact Us',
                                  onTap: () => scrollToSection(
                                      contactKey, context, false)),
                      ...
                      SectionContainer(
                        ...
                        child: Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment
                              .start, // Adjusted alignment to start
                          children: [
                            const Padding(
                              padding: EdgeInsets.only(
                                  top: 50.0), // Move text up a bit
                              child: Text(
                                '" Empowering Learning,\n  Connecting Minds "',
                                style: TextStyle(
                                  fontSize: 38,
                            ...
                            const Padding(
                              padding: EdgeInsets.only(
                                  top: 10.0), // Adjusted the top padding
                              child: Text(
                                ...
                                textAlign:
                                    TextAlign.justify, // Justify the paragraph
                              ),
                            ),
                            const SizedBox(height: 20),
                        ...
                        child: const SingleChildScrollView(
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  DiscoverCard(
                                    ...
                                    description:
                                        "Machine learning allows computers to learn from data and make decisions with minimal programming. It's the technology behind recommendations, smart assistants, and more, transforming data into intelligent insights.",
                                    image: 'assets/discover-1.jpg',
                                  ),
                                  DiscoverCard(
                                    title: "Statistics",
                                    description:
                                        "Statistics involves gathering and analyzing data to find patterns and make predictions. It's essential for making informed decisions in areas like healthcare, economics, and research.",
                              ...
                              SizedBox(
                                  height:
                                      30), // Space between the title and Discover More button
                              Text(
                              ...
                              Row(
                                ...
                                children: [
                                  ModuleCard(
                                    ...
                                    description:
                                        '10 Common Mistakes Every Beginner Programmer Makes and How to Avoid Them!',
                                  ),
                                  ModuleCard(
                                    imageAsset: 'assets/blog-2.jpg',
                                    description:
                                        'What’s It Really Like to Transition into Data Science Without a Math Background?',
                                  ),
                                  ModuleCard(
                                    imageAsset: 'assets/blog-3.jpg',
                                    description:
                                        'Exploring the Impact of IoT on Everyday Life | Innovations Around the Globe',
                                  ),
                                  ModuleCard(
                                    imageAsset: 'assets/blog-4.jpg',
                                    description:
                                        '11 Key Things to Know Before Starting a Career in Cybersecurity...',
                                  ),
                                ],
                              ),
                              SizedBox(
                                  height:
                                      100), // Add spacing at the bottom for a long page feel
                            ],
                          ),
                        ),
                      ),
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                backgroundColor: const Color.fromARGB(83, 39, 0,
                                    146), // Change the text color to white
                                padding: const EdgeInsets.symmetric(
                                    horizontal: 24, vertical: 12),
                                shape: const RoundedRectangleBorder(
                                  borderRadius: BorderRadius
                                      .zero, // No rounded corners (box type)
                                ),
                              ),
                              child: const Text(
                                "Predict Career Path ➔",
                      ...
                      SectionContainer(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(
                                height:
                                    20), // Reduced height for spacing between text and circles
                            const Row(
                              mainAxisAlignment:
                              ...
                              children: [
                                ...
                                SizedBox(
                                    width:
                                        80), // Reduced width to minimize distance between circles
                                ContactOption(
                                  icon: Icons.email,
                            ...
                            const SizedBox(
                                height:
                                    45), // Spacing between ContactOption and "Academist" title
                            const Text(
                              "ACADEMIST",
                              style: TextStyle(
                                fontSize: 15,
                            ...
                            const SizedBox(
                                height:
                                    10), // Spacing between "ACADEMIST" title and social icons
                            Row(
        ...
        children: [
          Stack(
            children: [
              ...
              Positioned(
                bottom:
                    20, // Position the description at the bottom of the image
                left: 10,
                right: 10,
                child: Container(
            ...
            child: Padding(
              ...
              child: child ??
                  Center(
                      child: Text(text,
                          style: TextStyle(
                              fontSize: 36, color: textColor ?? Colors.white))),
            ),
          ),
          if (image != null)
            Expanded(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(
                  height: 16), // Space between description and button
              ElevatedButton(
                onPressed: () {
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  shape: const RoundedRectangleBorder(
                    borderRadius:
                        BorderRadius.zero, // Box shape (no rounded corners)
                  ),
                  side: const BorderSide(
                      color: Colors.white,
                      width: 2), // Optional: white border for contrast
                ),
                child: const Row(
...
class SignInButton extends StatelessWidget {
  ...
  const SignInButton(
      {super.key, required this.onPressed, this.text = 'Sign In'});
