...
class ResQuizPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'ResQuiz Page',  // Change this title to something suitable for your page
            ...
            children: [
              ...
              Center(
                child: Column(
                  children: [
                    const Text(
                      'Test Your Knowledge with ResQuiz....',
                      style: TextStyle(
                        fontSize: 40,
                    ...
                    const Text(
                      'Challenge yourself and enhance your skills with ResQuiz. Explore multiple categories and track your progress.',
